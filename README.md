...
- Moreover, the native graph representation format used by `ggen`, `sub_search` and related programs &mdash; effectively the adjacency lists corresponding to the upper-triangular portion of the adjacency matrix &mdash; is non-standard and does not lend itself to visualization or manipulation.
